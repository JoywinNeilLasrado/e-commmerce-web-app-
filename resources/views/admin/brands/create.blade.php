...
<div class="bg-gray-50 min-h-screen py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-black text-gray-900 tracking-tight">Add New Brand</h1>
                <p class="text-sm text-gray-500 mt-1 font-medium">Create a new device manufacturer in your store.</p>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex flex-col items-center gap-4 py-4">
                            <div class="relative group">
                                <div class="w-24 h-24 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden group-hover:border-blue-400 transition-colors" id="logo-preview-container">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-[10px] text-gray-400 font-medium mt-0.5">Recommended: Square SVG or PNG (Max 2MB)</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="3" 
                                          ...
                                          class="block w-full rounded-xl border-gray-200 text-sm focus:ring-blue-500 focus:border-blue-500 py-3 px-4 shadow-sm placeholder:text-gray-300 resize-none">{{ old('description') }}</textarea>
                            </div>
